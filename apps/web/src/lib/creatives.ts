...
export function creativeKindLabel(kind: CreativeKind): string {
  switch (kind) {
    case "markdown":
      return "Document";
    case "image":
...
export function formatCreativeBytes(bytes?: number): string | null {
...
export function formatCreativeTime(iso: string): string {
...
export function creativeDataUrl(result: CreativeReadResult): string {
