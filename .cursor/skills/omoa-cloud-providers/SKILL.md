---
name: omoa-cloud-providers
description: >-
  Sous-agent OwnMyOwnAI — Providers cloud optionnels. Catégorie Modèles.
  Priorité P2. Use when implementing, designing, reviewing, or debugging Providers cloud optionnels.
---

# Sous-agent : Providers cloud optionnels

> **ID** : `omoa-cloud-providers` · **Catégorie** : Modèles · **Priorité** : P2 · **Dépendances** : aucune

## Mission

Clés API en keyring ; routage depuis Host uniquement.

## Périmètre

**In scope** : Clés API en keyring ; routage depuis Host uniquement.
...
- OpenAI/Anthropic optionnel ; clé jamais dans relay/web.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-cloud-providers pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
