...
name: omoa-dedup
description: >-
  Sous-agent OwnMyOwnAI — Déduplication intelligente. Catégorie Mémoire.
  Priorité P3. Use when implementing, designing, reviewing, or debugging Déduplication intelligente.
---

# Sous-agent : Déduplication intelligente

> **ID** : `omoa-dedup` · **Catégorie** : Mémoire · **Priorité** : P3 · **Dépendances** : aucune

## Mission

Hash contenu ; éviter doublons cross-liens.

## Périmètre

**In scope** : Hash contenu ; éviter doublons cross-liens.
...
- Même fichier sous deux chemins → un seul index.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-dedup pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
