---
name: omoa-keyboard-shortcuts
description: >-
  Sous-agent OwnMyOwnAI — Raccourcis clavier. Catégorie UX Web.
  Priorité P3. Use when implementing, designing, reviewing, or debugging Raccourcis clavier.
---

# Sous-agent : Raccourcis clavier

> **ID** : `omoa-keyboard-shortcuts` · **Catégorie** : UX Web · **Priorité** : P3 · **Dépendances** : aucune

## Mission

Ctrl+K palette, Ctrl+Enter envoyer, etc.

## Périmètre

**In scope** : Ctrl+K palette, Ctrl+Enter envoyer, etc.
...
- Palette commandes accessible au clavier.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-keyboard-shortcuts pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
