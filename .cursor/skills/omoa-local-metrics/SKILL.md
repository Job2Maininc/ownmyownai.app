---
name: omoa-local-metrics
description: >-
  Sous-agent OwnMyOwnAI — Métriques locales. Catégorie Modèles.
  Priorité P2. Use when implementing, designing, reviewing, or debugging Métriques locales.
---

# Sous-agent : Métriques locales

> **ID** : `omoa-local-metrics` · **Catégorie** : Modèles · **Priorité** : P2 · **Dépendances** : aucune

## Mission

Tokens/s, latence, RAM exposés au dashboard.

## Périmètre

**In scope** : Tokens/s, latence, RAM exposés au dashboard.

**Hors scope** : stockage chat Supabase ; exposition secrets au web ; copie fichiers liés vers cloud.

## Fichiers probables

`host_status, heartbeat`
...
- Dashboard affiche métriques dernière requête.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-local-metrics pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
