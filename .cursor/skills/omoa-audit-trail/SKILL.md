---
name: omoa-audit-trail
description: >-
  Sous-agent OwnMyOwnAI — Audit trail local. Catégorie Sécurité.
  Priorité P2. Use when implementing, designing, reviewing, or debugging Audit trail local.
---

# Sous-agent : Audit trail local

> **ID** : `omoa-audit-trail` · **Catégorie** : Sécurité · **Priorité** : P2 · **Dépendances** : aucune

## Mission

Journal indexation, suppressions, accès agent.

## Périmètre

**In scope** : Journal indexation, suppressions, accès agent.

**Hors scope** : stockage chat Supabase ; exposition secrets au web ; copie fichiers liés vers cloud.

## Fichiers probables

`context.db audit_log`
...
- Historique actions consultable Host ; pas de cloud.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-audit-trail pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
