---
name: omoa-project-rules
description: >-
  Sous-agent OwnMyOwnAI — Rules / .cursorrules par projet. Catégorie Cursor.
  Priorité P2. Use when implementing, designing, reviewing, or debugging Rules / .cursorrules par projet.
---

# Sous-agent : Rules / .cursorrules par projet

> **ID** : `omoa-project-rules` · **Catégorie** : Cursor · **Priorité** : P2 · **Dépendances** : omoa-projects

## Mission

Lire .ownmyownai/rules.md ou .cursorrules dans dossiers liés.

## Périmètre

**In scope** : Lire .ownmyownai/rules.md ou .cursorrules dans dossiers liés.
...
- Règles du dossier lié injectées automatiquement au chat du projet.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-project-rules pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
