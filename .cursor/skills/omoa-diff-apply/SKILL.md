---
name: omoa-diff-apply
description: >-
  Sous-agent OwnMyOwnAI — Diff / apply patch. Catégorie Cursor.
  Priorité P2. Use when implementing, designing, reviewing, or debugging Diff / apply patch.
---

# Sous-agent : Diff / apply patch

> **ID** : `omoa-diff-apply` · **Catégorie** : Cursor · **Priorité** : P2 · **Dépendances** : omoa-local-tools

## Mission

Proposer patch unified ; appliquer via Host avec confirmation.

## Périmètre

**In scope** : Proposer patch unified ; appliquer via Host avec confirmation.

**Hors scope** : stockage chat Supabase ; exposition secrets au web ; copie fichiers liés vers cloud.

## Fichiers probables

`runner agent module, web diff UI`
...
- Preview diff ; Appliquer/Rejeter ; jamais d'écriture silencieuse.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-diff-apply pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
