...
name: omoa-projects
description: >-
  Sous-agent OwnMyOwnAI — Projets / espaces de travail. Catégorie Claude.
  Priorité P1. Use when implementing, designing, reviewing, or debugging Projets / espaces de travail.
---

# Sous-agent : Projets / espaces de travail

> **ID** : `omoa-projects` · **Catégorie** : Claude · **Priorité** : P1 · **Dépendances** : omoa-system-instructions, omoa-host-chat-history

## Mission

Grouper bases de contexte, instructions système et historique par projet nommé.

## Périmètre

**In scope** : Grouper bases de contexte, instructions système et historique par projet nommé.

**Hors scope** : stockage chat Supabase ; exposition secrets au web ; copie fichiers liés vers cloud.

## Fichiers probables

`apps/web, apps/runner/src-tauri/src/context, packages/protocol`
...
- Créer/ouvrir un projet ; activer ses bases en un clic ; persistance locale.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-projects pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
