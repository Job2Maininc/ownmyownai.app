...
Panneau pour markdown/tableaux générés, export local.

## Périmètre

**In scope** : Panneau pour markdown/tableaux générés, export local.
...
- L'assistant peut ouvrir un artefact ; l'utilisateur copie/télécharge sans cloud.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-artifacts pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
