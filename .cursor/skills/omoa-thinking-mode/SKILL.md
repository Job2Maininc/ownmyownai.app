---
name: omoa-thinking-mode
description: >-
  Sous-agent OwnMyOwnAI — Mode réflexion / raisonnement. Catégorie Claude.
  Priorité P2. Use when implementing, designing, reviewing, or debugging Mode réflexion / raisonnement.
---

# Sous-agent : Mode réflexion / raisonnement

> **ID** : `omoa-thinking-mode` · **Catégorie** : Claude · **Priorité** : P2 · **Dépendances** : aucune

## Mission

Route modèles thinking ; UI repliable pour chaîne de pensée.

## Périmètre

**In scope** : Route modèles thinking ; UI repliable pour chaîne de pensée.

**Hors scope** : stockage chat Supabase ; exposition secrets au web ; copie fichiers liés vers cloud.

## Fichiers probables

`ollama.rs, chat-view, settings`
...
- Sélecteur mode normal/réflexion ; streaming séparé pensée/réponse.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-thinking-mode pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
