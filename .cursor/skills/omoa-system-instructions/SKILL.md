---
name: omoa-system-instructions
description: >-
  Sous-agent OwnMyOwnAI — Instructions personnalisées. Catégorie Claude.
  Priorité P1. Use when implementing, designing, reviewing, or debugging Instructions personnalisées.
---

# Sous-agent : Instructions personnalisées

> **ID** : `omoa-system-instructions` · **Catégorie** : Claude · **Priorité** : P1 · **Dépendances** : omoa-projects

## Mission

Prompt système par base/projet injecté avant RAG dans chat.start.

## Périmètre

**In scope** : Prompt système par base/projet injecté avant RAG dans chat.start.

**Hors scope** : stockage chat Supabase ; exposition secrets au web ; copie fichiers liés vers cloud.

## Fichiers probables

`apps/runner/src-tauri/src/settings.rs, relay.rs, chat-view`
...
- Instruction éditable Host ; visible web lecture seule ; appliquée au prochain message.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-system-instructions pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
