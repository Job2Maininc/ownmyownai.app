---
name: omoa-context-db-encryption
description: >-
  Sous-agent OwnMyOwnAI — Chiffrement context.db. Catégorie Sécurité.
  Priorité P2. Use when implementing, designing, reviewing, or debugging Chiffrement context.db.
---

# Sous-agent : Chiffrement context.db

> **ID** : `omoa-context-db-encryption` · **Catégorie** : Sécurité · **Priorité** : P2 · **Dépendances** : aucune

## Mission

Chiffrer SQLite au repos via DPAPI Windows.

## Périmètre

**In scope** : Chiffrer SQLite au repos via DPAPI Windows.
...
- DB illisible sans session Windows utilisateur.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-context-db-encryption pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
