---
name: omoa-rag-citations
description: >-
  Sous-agent OwnMyOwnAI — Citations RAG explicites. Catégorie Claude.
  Priorité P1. Use when implementing, designing, reviewing, or debugging Citations RAG explicites.
---

# Sous-agent : Citations RAG explicites

> **ID** : `omoa-rag-citations` · **Catégorie** : Claude · **Priorité** : P1 · **Dépendances** : aucune

## Mission

Retourner source fichier + extrait + score ; afficher badges cliquables.

## Périmètre

**In scope** : Retourner source fichier + extrait + score ; afficher badges cliquables.

**Hors scope** : stockage chat Supabase ; exposition secrets au web ; copie fichiers liés vers cloud.

## Fichiers probables

`apps/runner/src-tauri/src/context/rag.rs, relay.rs, chat-view`
...
- Chaque affirmation RAG cite au moins un chunk avec chemin tronqué.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-rag-citations pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
