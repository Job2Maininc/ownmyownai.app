---
name: omoa-scheduled-sync
description: >-
  Sous-agent OwnMyOwnAI — Sync planifiée (cron). Catégorie Codex.
  Priorité P3. Use when implementing, designing, reviewing, or debugging Sync planifiée (cron).
---

# Sous-agent : Sync planifiée (cron)

> **ID** : `omoa-scheduled-sync` · **Catégorie** : Codex · **Priorité** : P3 · **Dépendances** : aucune

## Mission

Resync liens à heure fixe ; rapport local.

## Périmètre

**In scope** : Resync liens à heure fixe ; rapport local.
...
- Cron configurable ; log dernière exécution par lien.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-scheduled-sync pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
