---
name: omoa-extension-policy
description: >-
  Sous-agent OwnMyOwnAI — Politique par extension. Catégorie Sécurité.
  Priorité P2. Use when implementing, designing, reviewing, or debugging Politique par extension.
---

# Sous-agent : Politique par extension

> **ID** : `omoa-extension-policy` · **Catégorie** : Sécurité · **Priorité** : P2 · **Dépendances** : aucune

## Mission

Allowlist extensions par lien.

## Périmètre

**In scope** : Allowlist extensions par lien.
...
- Lien n'indexe que extensions configurées.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-extension-policy pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
