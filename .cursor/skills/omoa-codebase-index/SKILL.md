---
name: omoa-codebase-index
description: >-
  Sous-agent OwnMyOwnAI — Index codebase Git. Catégorie Cursor.
  Priorité P2. Use when implementing, designing, reviewing, or debugging Index codebase Git.
---

# Sous-agent : Index codebase Git

> **ID** : `omoa-codebase-index` · **Catégorie** : Cursor · **Priorité** : P2 · **Dépendances** : aucune

## Mission

Lier repo ; index symboles + embeddings ; exclusions .git.

## Périmètre

**In scope** : Lier repo ; index symboles + embeddings ; exclusions .git.

**Hors scope** : stockage chat Supabase ; exposition secrets au web ; copie fichiers liés vers cloud.

## Fichiers probables

`context/sync.rs, index module`
...
- Lier repo local ; recherche symbole/fichier dans le chat.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-codebase-index pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
