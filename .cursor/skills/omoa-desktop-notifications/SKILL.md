---
name: omoa-desktop-notifications
description: >-
  Sous-agent OwnMyOwnAI — Notifications desktop. Catégorie UX Web.
  Priorité P2. Use when implementing, designing, reviewing, or debugging Notifications desktop.
---

# Sous-agent : Notifications desktop

> **ID** : `omoa-desktop-notifications` · **Catégorie** : UX Web · **Priorité** : P2 · **Dépendances** : omoa-background-agent

## Mission

Notifier fin indexation/agent.

## Périmètre

**In scope** : Notifier fin indexation/agent.

**Hors scope** : stockage chat Supabase ; exposition secrets au web ; copie fichiers liés vers cloud.

## Fichiers probables

`tray.rs, tauri notification`
...
- Toast Windows quand sync/agent terminé.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-desktop-notifications pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
