---
name: omoa-vision-context
description: >-
  Sous-agent OwnMyOwnAI — Images dans le contexte. Catégorie Mémoire.
  Priorité P3. Use when implementing, designing, reviewing, or debugging Images dans le contexte.
---

# Sous-agent : Images dans le contexte

> **ID** : `omoa-vision-context` · **Catégorie** : Mémoire · **Priorité** : P3 · **Dépendances** : aucune

## Mission

Supporter .png/.jpg liés ; modèle vision local.

## Périmètre

**In scope** : Supporter .png/.jpg liés ; modèle vision local.

**Hors scope** : stockage chat Supabase ; exposition secrets au web ; copie fichiers liés vers cloud.

## Fichiers probables

`ingest, ollama vision`
...
- Image liée décrite/indexée ; utilisable en question vision.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-vision-context pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
