---
name: omoa-conversation-branches
description: >-
  Sous-agent OwnMyOwnAI — Branches de conversation. Catégorie Claude.
  Priorité P3. Use when implementing, designing, reviewing, or debugging Branches de conversation.
---

# Sous-agent : Branches de conversation

> **ID** : `omoa-conversation-branches` · **Catégorie** : Claude · **Priorité** : P3 · **Dépendances** : omoa-host-chat-history

## Mission

Fork depuis un message ; arbre local.

## Périmètre

**In scope** : Fork depuis un message ; arbre local.

**Hors scope** : stockage chat Supabase ; exposition secrets au web ; copie fichiers liés vers cloud.

## Fichiers probables

`apps/web chat, history store`
...
- Repartir du message N sans écraser le fil principal.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-conversation-branches pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
