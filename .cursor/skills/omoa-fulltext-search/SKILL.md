---
name: omoa-fulltext-search
description: >-
  Sous-agent OwnMyOwnAI — Recherche full-text. Catégorie Mémoire.
  Priorité P2. Use when implementing, designing, reviewing, or debugging Recherche full-text.
---

# Sous-agent : Recherche full-text

> **ID** : `omoa-fulltext-search` · **Catégorie** : Mémoire · **Priorité** : P2 · **Dépendances** : aucune

## Mission

FTS sur chunks + noms fichiers en complément embeddings.

## Périmètre

**In scope** : FTS sur chunks + noms fichiers en complément embeddings.
...
- Recherche « contrat 2024 » trouve chunk même sans similarité sémantique.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-fulltext-search pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
