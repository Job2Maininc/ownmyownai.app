---
name: omoa-air-gapped
description: >-
  Sous-agent OwnMyOwnAI — Mode air-gapped. Catégorie Sécurité.
  Priorité P3. Use when implementing, designing, reviewing, or debugging Mode air-gapped.
---

# Sous-agent : Mode air-gapped

> **ID** : `omoa-air-gapped` · **Catégorie** : Sécurité · **Priorité** : P3 · **Dépendances** : aucune

## Mission

Désactiver relay/cloud ; LAN optionnel.

## Périmètre

**In scope** : Désactiver relay/cloud ; LAN optionnel.
...
- Mode offline total ; chat local uniquement.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-air-gapped pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
