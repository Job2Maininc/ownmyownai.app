...
name: omoa-pr-review
description: >-
  Sous-agent OwnMyOwnAI — PR / review assisté. Catégorie Codex.
  Priorité P3. Use when implementing, designing, reviewing, or debugging PR / review assisté.
---

# Sous-agent : PR / review assisté

> **ID** : `omoa-pr-review` · **Catégorie** : Codex · **Priorité** : P3 · **Dépendances** : omoa-codebase-index, omoa-local-tools

## Mission

Résumer diff git ; checklist sécurité.

## Périmètre

**In scope** : Résumer diff git ; checklist sécurité.

**Hors scope** : stockage chat Supabase ; exposition secrets au web ; copie fichiers liés vers cloud.

## Fichiers probables

`agent + gh integration`
...
- Sur repo lié : coller diff → review structurée locale.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-pr-review pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
