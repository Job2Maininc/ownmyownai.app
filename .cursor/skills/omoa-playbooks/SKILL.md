...
name: omoa-playbooks
description: >-
  Sous-agent OwnMyOwnAI — Skills / playbooks. Catégorie Codex.
  Priorité P2. Use when implementing, designing, reviewing, or debugging Skills / playbooks.
---

# Sous-agent : Skills / playbooks

> **ID** : `omoa-playbooks` · **Catégorie** : Codex · **Priorité** : P2 · **Dépendances** : omoa-multi-step-agent

## Mission

Recettes réutilisables déclenchables depuis UI.

## Périmètre

**In scope** : Recettes réutilisables déclenchables depuis UI.

**Hors scope** : stockage chat Supabase ; exposition secrets au web ; copie fichiers liés vers cloud.

## Fichiers probables

`.cursor/skills, web playbook picker`
...
- Choisir playbook « Résumer dossier » ; exécute workflow agent.
...
Dans Cursor, demander : *« Utilise le sous-agent omoa-playbooks pour [tâche] »* ou lancer un agent Task avec ce skill en contexte.
